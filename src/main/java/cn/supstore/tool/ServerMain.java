...
public class ServerMain {
    public static void main(String args[]) throws Exception {
        ...
        Handler jee = createApp("/saleeasy");
...
//        server.dump(System.err);
    ...
    private static Handler createApp(String path) throws IOException {
        ...
        if (devEnvDir.exists())
            ...
            webRootPath = ServerMain.class.getProtectionDomain().getCodeSource().getLocation().toExternalForm();
        ...
        String className = ServerMain.class.getName().replace('.', '/');
        String classJar = ServerMain.class.getResource("/" + className + ".class").toString();
    ...
    private static Handler resourceContext(String path) throws Exception {
        URL warPath = ServerMain.class.getProtectionDomain().getCodeSource().getLocation();
